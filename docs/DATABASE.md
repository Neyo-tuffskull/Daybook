...
**Plan, occurrence and actual are three different things.** A recurring "Gym, Mon/Wed/Thu/Sat at 18:00" is a _plan_. Wednesday the 3rd at 18:00 is an _occurrence_. Starting at 18:05 and finishing at 19:12 is the _actual_. Most planner apps collapse these and then cannot answer "how often do I start late", which is the analysis your brief asks for in §18. Here they are separate columns on separate concepts.
